...
double *** d3array(int dim1, int dim2, dim3)
{
	int t;
	double ***xi;

	xi = (double ***) malloc(dim1*sizeof(double **));

	xi --;

	for (t = 1; t <= dim1; t++)
		xi[t] = dmatrix(1, dim2, 1, dim3);
	return xi;
}
...
int *** i3array(int dim1, int dim2, int dim3)
{
	...
	xi = (int ***) malloc(dim1*sizeof(double **));

	xi --;

	for (t = 1; t <= dim1; t++)
		xi[t] = imatrix(1, dim2, 1, dim3);
	return xi;
}
